...
describe("StatsPort", () => {
    describe("getTopAssociations", () => {
        it("should return data", async () => {
            ...
            vi.mocked(requestsService.get).mockImplementationOnce(async () => ({ data: { data: expected } }));
    ...
    describe("getMonthlyUserCount", () => {
        ...
        beforeAll(() => vi.mocked(requestsService.get).mockResolvedValue({ data: { data: AXIOS_DATA } }));
        afterAll(() => vi.mocked(requestsService.get).mockRestore());
    ...
    describe("getMonthlyRequestCount", () => {
        ...
        beforeAll(() => vi.mocked(requestsService.get).mockResolvedValue({ data: AXIOS_DATA }));
        afterAll(() => vi.mocked(requestsService.get).mockRestore());
