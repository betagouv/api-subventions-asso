...
const ERROR_MESSAGES = {
    [ResetPasswordErrorCodes.RESET_TOKEN_NOT_FOUND]: `<p>Ce lien n'est pas valide, vérifiez que l'URL est bien celle envoyée par mail.</p>
        <p>Il est possible que votre lien a expiré, allez sur <a href="/auth/forget-password" target="_blank" rel="noopener noreferrer">la page mot de passe oublié</a> pour recevoir un nouveau lien d'activation.</p>`,
