...
export class ResetPwdController {
    ...
    ERROR_MESSAGES = {
        ...
        404: "Ce lien n'est pas valide, vérifiez que l'URL est bien celle envoyée par mail.",
    ...
    constructor(token) {
        ...
        this.promise = new Store(token ? Promise.resolve() : Promise.reject({ httpCode: 404 }));
