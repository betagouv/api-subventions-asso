const { default: dataLogAdapter } = require("../build/src/dataProviders/db/data-log/data-log.adapter.js");

module.exports = {
    async up(db) {
        const lastDate = await dataLogAdapter.getLastImportByProvider("fonjep");
