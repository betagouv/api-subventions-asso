...
export const APPLICATION_FLAT_DBOS: ApplicationFlatDbo[] = [
    {
...
export const APPLICATION_FLAT_DTOS: ApplicationFlatDto[] = [
    {
        ...APPLICATION_FLAT_DBOS[0],
        dateConvention: (APPLICATION_FLAT_DBOS[0].dateConvention as Date).toISOString(),
        dateDecision: (APPLICATION_FLAT_DBOS[0].dateDecision as Date).toISOString(),
        dateDepotDemande: (APPLICATION_FLAT_DBOS[0].dateDepotDemande as Date).toISOString(),
        datesPeriodeVersement: (APPLICATION_FLAT_DBOS[0].datesPeriodeVersement as Date[]).map(date =>
            date.toISOString(),
        ),
        dateMiseAJour: APPLICATION_FLAT_DBOS[0].dateMiseAJour.toISOString(),
    },
];
