...
export default class ApplicationFlatAdapter {
    ...
    public static buildEntity(draft: ApplicationFlatEntityDraft): ApplicationFlatEntity {
        return {
            ...
            uniqueId: `${draft.provider}--${draft.applicationProviderId}--${draft.financialYear}`,
        };
    }
    ...
    public static toDemandeSubvention(entity: ApplicationFlatEntity): DemandeSubvention | null {
        ...
        return {
            ...
            pluriannualite: toPvOrUndefined(entity.plurinannual),
            service_instructeur: toPv(entity.instructiveDepartmentName || ""),
            siret: toPv(siret.value),
            sous_dispositif: toPvOrUndefined(entity.underSystem),
            ...
            dispositif: toPvOrUndefined(entity.system),
            montants: {
    ...
    public static dboToEntity(dbo: ApplicationFlatDbo): ApplicationFlatEntity {
        return {
            ...
            financialYear: dbo.exerciceBudgetaire,
            plurinannual: dbo.pluriannualite,
            ...
            system: dbo.dispositif,
            underSystem: dbo.sousDispositif,
            ...
            paymentPeriodDate: dbo.datesPeriodeVersement,
            ...
            applicationPercentage: dbo.pourcentageSubvention,
        };
    }
    ...
    public static entityToDbo(entity: ApplicationFlatEntity): Omit<ApplicationFlatDbo, "_id"> {
        return {
            ...
            exerciceBudgetaire: entity.financialYear,
            pluriannualite: entity.plurinannual,
            ...
            dispositif: entity.system,
            sousDispositif: entity.underSystem,
            ...
            datesPeriodeVersement: entity.paymentPeriodDate,
            ...
            pourcentageSubvention: entity.applicationPercentage,
        };
    }
}
