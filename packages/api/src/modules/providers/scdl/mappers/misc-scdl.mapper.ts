...
export default class MiscScdlMapper {
    ...
    static dboToApplicationFlat(dbo: ScdlGrantDbo): ApplicationFlatEntity {
        ...
        return {
            ...
            paymentCondition: MiscScdlMapper.normalizePaymentConditions(dbo.paymentConditions),
            ...
            paymentPeriodDates: MiscScdlMapper.getNormalizedPaymentDates(dbo.paymentStartDate, dbo.paymentEndDate),
            ...
            nature: MiscScdlMapper.normalizePaymentNature(dbo.paymentNature),
