        ...
        return {
            rna: data.unite_legale.identifiant_association
                ? ProviderValueAdapter.toProviderValues(
                      data.unite_legale.identifiant_association,
                      EntrepriseDtoAdapter.PROVIDER_NAME,
                      new Date(data.unite_legale.updated_at)
                  )
                : undefined,
            ...
            nic_siege: ProviderValueAdapter.toProviderValues(
                data.unite_legale.nic_siege,
                EntrepriseDtoAdapter.PROVIDER_NAME,
                new Date(data.unite_legale.updated_at)
            ),
            categorie_juridique: ProviderValueAdapter.toProviderValues(
                data.unite_legale.categorie_juridique,
                EntrepriseDtoAdapter.PROVIDER_NAME,
                new Date(data.unite_legale.updated_at)
            ),
            date_creation_siren: ProviderValueAdapter.toProviderValues(
                new Date(data.unite_legale.date_creation),
                EntrepriseDtoAdapter.PROVIDER_NAME,
                new Date(data.unite_legale.updated_at)
            ),
            date_modification_siren: ProviderValueAdapter.toProviderValues(
                new Date(data.unite_legale.updated_at),
                EntrepriseDtoAdapter.PROVIDER_NAME,
                new Date(data.unite_legale.updated_at)
            ),
            denomination_siren: ProviderValueAdapter.toProviderValues(
                data.unite_legale.denomination,
                EntrepriseDtoAdapter.PROVIDER_NAME,
                new Date(data.unite_legale.updated_at)
            ),
            adresse_siege_siren: data.unite_legale.etablissement_siege
                ? ProviderValueAdapter.toProviderValues(
                      {
                ...
                : undefined,
            etablisements_siret: data.unite_legale.etablissements
                ? ProviderValueAdapter.toProviderValues(
