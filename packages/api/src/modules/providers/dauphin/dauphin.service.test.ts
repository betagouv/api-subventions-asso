...
describe("Dauphin Service", () => {
    ...
    describe("getDemandeSubventionBySiret", () => {
        const getLastUpdateMock: jest.SpyInstance<unknown> = jest.spyOn(dauhpinCachesRepository, "getLastUpdateBySiren");
        ...
        const getDauphinSubventionsMock: jest.SpyInstance<unknown> = jest.spyOn(dauphinService, "getDauphinSubventions")
    ...
    describe("formatDateToDauphinDate", () => {
        it('should format date', () => {
            ...
            expect(dauphinService.formatDateToDauphinDate(new Date(dateString))).toEqual("1970\\-01\\-01T01\\:00\\:00.000Z")
        })
    })

    describe("getAuthToken", () => {
        const getDauphinTokenMock: jest.SpyInstance<unknown> = jest.spyOn(configurationsService, 'getDauphinToken');
        const getDauphinTokenAvailableTimeMock: jest.SpyInstance<unknown> = jest.spyOn(configurationsService, 'getDauphinTokenAvailableTime');
