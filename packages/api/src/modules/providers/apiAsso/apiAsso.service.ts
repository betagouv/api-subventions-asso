...
export class ApiAssoService implements AssociationsProvider, EtablissementProvider, DocumentProvider {
    ...
    private async findFullScopeAssociation(identifier: AssociationIdentifiers): Promise<{ associations: Association[], etablissements: Etablissement[] } | null> {
    ...
    private async findDocuments(identifier: AssociationIdentifiers): Promise<Document[] | null> {
        ...
        const structure = { document_rna: response.asso.documents.document_rna, document_dac: response.asso.documents.document_dac };
