...
import FonjepDispositifDto from "../../../../adapters/db/providers/fonjep/dto/fonjepDispositifDto";
import { FonjepPosteDtoWithJSDate } from "../../../../adapters/db/providers/fonjep/dto/fonjepPosteDto";
import FonjepTypePosteDto from "../../../../adapters/db/providers/fonjep/dto/fonjepTypePosteDto";
import { FonjepVersementDto } from "../../../../adapters/db/providers/fonjep/dto/fonjepVersementDto";
import FonjepTiersDto from "../../../../adapters/db/providers/fonjep/dto/fonjepTiersDto";
 ...
 */
export default class FonjepEntityMapper {
    ...
    private static buildFlatPaymentId(data: { thirdParty: FonjepTiersEntity; position: FonjepPosteEntity }) {
        ...
        return `${position.code}-${getShortISODate(FonjepEntityMapper.getConventionDate(position))}-${position.annee}-${
