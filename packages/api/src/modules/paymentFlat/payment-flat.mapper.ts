...
import PaymentFlatDbo from "../../adapters/outputs/db/payment-flat/@types/PaymentFlatDbo";
...
export default class PaymentFlatMapper {
    ...
    public static toPayment(entity: PaymentFlatEntity): Payment {
        const toPvPaymentFlat = <T>(value: T) =>
            ProviderValueMapper.toProviderValue<T>(value, entity.provider, entity.operationDate);
        ...
        if (entity?.ej && entity.ej !== GenericAdapter.NOT_APPLICABLE_VALUE) {
            ...
            return {
                ...basePayment,
                codePoste: toPvOrUndefined(FonjepEntityMapper.extractPositionCode(entity as FonjepPaymentFlatEntity)),
            } as FonjepPayment;
    }
