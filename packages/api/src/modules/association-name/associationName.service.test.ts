import assocationNameService from "./associationName.service";
...
describe("associationName.service", () => {
    describe("getNameFromIdentifier()", () => {
        ...
        const mostRecentMock = jest.spyOn(assocationNameService, "_getMostRecentEntity");
        ...
        afterAll(() => {
            repoMock.mockClear();
            mostRecentMock.mockClear();
        });

        it("should call repo", async () => {
            await assocationNameService.getNameFromIdentifier(IDENTIFIER);
        ...
        it("should return name most recent result", async () => {
            ...
            const actual = await assocationNameService.getNameFromIdentifier(IDENTIFIER);
