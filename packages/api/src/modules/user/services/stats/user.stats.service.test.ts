...
describe("user stats service", () => {
    ...
    describe("updateNbRequests", () => {
        ...
        const mockUpdateByDateSpy: SpyInstance = jest.spyOn(userStatsService, "updateNbRequestsByDate");
    ...
    describe("updateNbRequestsByDate", () => {
        // @ts-expect-error: mock private method
        const mockUpdateNbRequestsInBrevo: SpyInstance = jest.spyOn(userStatsService, "updateNbRequestsInBrevo");
