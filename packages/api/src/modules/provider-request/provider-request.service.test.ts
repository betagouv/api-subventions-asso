...
import ProviderRequestFactory, { ProviderRequestService } from "./provider-request.service";
import providerRequestAdapter from "../../adapters/outputs/db/provider-request/provider-request.adapter";

jest.mock("../../adapters/outputs/db/provider-request/provider-request.adapter");
