...
export class UniqueVisitByDayAdapter extends MongoAdapter<AssociationVisitEntity> implements StatsUniqueVisitByDayPort {
...
const uniqueVisitByDayAdapter = new UniqueVisitByDayAdapter();
export default uniqueVisitByDayAdapter;
