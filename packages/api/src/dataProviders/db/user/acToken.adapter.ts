...
class AgentConnectTokenAdapter extends MongoAdapter<AgentConnectTokenDbo> implements AcTokenPort {
...
const agentConnectTokenAdapter = new AgentConnectTokenAdapter();
export default agentConnectTokenAdapter;
