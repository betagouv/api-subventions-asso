...
describe("PaymentFlat Port", () => {
    ...
    describe("insertOne()", () => {
        it("should call insertOne with the correct arguments", async () => {
            await paymentFlatAdapter.insertOne(CHORUS_PAYMENT_FLAT_ENTITY);
    ...
    describe("upsertOne()", () => {
        it("should call toDbo()", async () => {
            await paymentFlatAdapter.upsertOne(CHORUS_PAYMENT_FLAT_ENTITY);
    ...
    describe("deleteAll()", () => {
        it("should call deleteMany", async () => {
            await paymentFlatAdapter.deleteAll();
    ...
    describe("upsertMany", () => {
        ...
        const mockBuildUpsertOperation = jest.spyOn(paymentFlatAdapter, "buildUpsertOperation");
        ...
        it("should call buildUpsertOperation for each entity", () => {
            paymentFlatAdapter.upsertMany(LIST_PAYMENT_FLAT_ENTITY);
    ...
    describe("buildUpsertOperation", () => {
        it("returns bulk operation", () => {
            ...
            const actual = paymentFlatAdapter.buildUpsertOperation(entity);
    ...
    describe("cursorFindChorusOnly()", () => {
        ...
        beforeAll(() => {
            mockCursorFind = jest.spyOn(paymentFlatAdapter, "cursorFind").mockImplementation(jest.fn());
        });
        ...
        it("should call cursorFind with provider filter", () => {
            paymentFlatAdapter.cursorFindChorusOnly();
        ...
        it("should call cursorFind with provider and exerciceBudgetaire filter", () => {
            ...
            paymentFlatAdapter.cursorFindChorusOnly(exerciceBudgetaire);
