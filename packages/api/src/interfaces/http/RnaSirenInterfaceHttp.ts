...
@Tags("Open Data")
export class RnaSirenInterfaceHttp extends Controller {
    /**
    ...
    public async findBySiret(rna_ou_siren_ou_siret: StructureIdentifiers): Promise<RnaSirenResponseDto[]> {
        const identifier = isStartOfSiret(rna_ou_siren_ou_siret) ? siretToSiren(rna_ou_siren_ou_siret): rna_ou_siren_ou_siret;
