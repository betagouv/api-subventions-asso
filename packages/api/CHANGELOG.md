...
- **api:** proConnectUsers are active by default, not the reverse ([17ed2db](https://github.com/betagouv/api-subventions-asso/commit/17ed2db548f8c6aaf536b0e3b8ed8443fd8256e2))
...
- **api:** check proConnect enabled from ENV var ([2a27b67](https://github.com/betagouv/api-subventions-asso/commit/2a27b67cb7eb85d2b7991f6115347626579aba05))
...
- **api:** prevent proConnectUsers to change name ([2a7152a](https://github.com/betagouv/api-subventions-asso/commit/2a7152a519e60c2f267a69bf001eb56ec538a21b))
