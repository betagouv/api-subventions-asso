...
Le fichier `docker-compose.yml` définit l'ensemble des services dont le projet à besoin pour fonctionner en local avec un service monDb et un service S3.
